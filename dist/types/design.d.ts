...
export type DesignUpdateInput = Partial<Omit<Design, "id">> & {
    id: number;
};
...
export type DesignSuggestionCreateInput = Omit<DesignSuggestion, "id" | "createdAt">;
export type DesignSuggestionUpdateInput = Partial<Omit<DesignSuggestion, "id">> & {
    id: number;
};
...
export type ImageUpdateInput = Partial<Omit<Image, "id">> & {
    id: number;
};
